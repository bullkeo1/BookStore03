...
namespace BulkyBook03.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult Details(int id)
        {
            ...
            {
                OrderHeader =
                    _unitOfWork.OrderHeader.GetFirstOrDefault
        ...
        {
            OrderHeader orderHeader = _unitOfWork.OrderHeader.GetFirstOrDefault(o =>
                o.Id == OrderVM.OrderHeader.Id, includeProperties: "ApplicationUser");
            if (stripeToken != null)
            {
        ...
        public IActionResult GetOrderList(string status)
        {
            ...
            switch (status)
            {
                ...
                case "rejected":
                    ...
                    break;
                case"inprocess":
                    orderHeaderList = orderHeaderList.Where(o => o.OrderStatus == SD.PaymentStatusApproved ||
